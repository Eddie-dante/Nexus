...
// Make it available globally without redeclaring
window.supabaseClient = supabaseClient;

// Also make it available as supabase only if not already defined
if (typeof window.supabase === 'undefined') {
    window.supabase = supabaseClient;
}

// If supabase is already defined, don't redeclare it
